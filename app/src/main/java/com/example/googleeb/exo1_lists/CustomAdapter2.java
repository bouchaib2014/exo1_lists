...
public class CustomAdapter2 extends BaseAdapter {
    ...
    public CustomAdapter2(Context aContext,  List<Contact> listData, int layout, ArrayList<Integer> listItemIsChecked) {
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        checkItem = v.findViewById(R.id.radio_text_view_list);
